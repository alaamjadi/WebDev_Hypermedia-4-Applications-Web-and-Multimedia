...
fetch(URL.PERSON.DEFAULT + URL.PERSON.ID)
  ...
  .then(function (data) {
    ...
    return fetch(URL.PERSON.DEFAULT + URL.PERSON.ID + URL.PERSON.EVENTS);
  })
  .then(function (response) {
    if (response.status !== 200) {
      console.log("Fetch response failed. Status Code: " + response.status);
  ...
  .then(function (data) {
    ...
    return fetch(URL.PERSON.DEFAULT + URL.PERSON.ID + URL.PERSON.SERVICES);
  })
  .then(function (response) {
    if (response.status !== 200) {
      console.log("Fetch response failed. Status Code: " + response.status);
