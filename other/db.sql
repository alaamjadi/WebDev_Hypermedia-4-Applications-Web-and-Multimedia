...
(3, 'Listening Center', '["listening_number.png", "listeningcenter_01.jpg","listeningcenter_02.jpg","listeningcenter_03.jpg","listeningcenter_04.jpg","listeningcenter_05.jpg", "listeningcenter_06.jpg", "palliativecare_07.jpg"]', 'The Center for Listening and Guidance for Fragile Personsin the socio-health network in the southern area of ​​Milan is a “window” open to the public (Fragile citizens with their family members) from Monday to Friday (9:30-12:30) The Center is supervised by some Operators coordinated by a Case Manager Nurse (Cinzia Pellegrini), with the support of Consultants who lend their activities free of charge in support of frailties.',
  '["Organizer:", "Presented in:", "What it is and how it works",
  "The Center for Listening and Guidance for Fragile Personsin the socio-health network in the southern area of ​​Milan is a “window” open to the public (Fragile citizens with their family members) from Monday to Friday (9:30-12:30) The Center is supervised by some Operators coordinated by a Case Manager Nurse (Cinzia Pellegrini), with the support of Consultants who lend their activities free of charge in support of frailties.",
...
"If even the expert internal consultants of our second level do not have the competence to give adequate answers to complex needs, the fragile Citizens who access our Listening Center are directed to the public and third sector social and health services with which Milcare foundation Onlus has established collaborative relationships, thanks to the initiatives of the Territorial Hospital Program for continuity of care in the socio-health network in the southern area of ​​Milan and to the activities promoted by the territorial social table of the Municipality 5 in which the Milcare Onlus Foundation participates.",
"If you believe that you or a family member needs help, you can contact the completely free Milcare listening and orientation center.",
"How to access the Center","The Center (open to the public from Monday to Saturday, 9:30-12:30) can also be contacted by phone (02 12345678 - toll-free number 800123456 outside opening hours, you can leave a message on the answering machine (you will be called back as soon as possible). It is also possible to send an E-mail to info@milcare.org : you will receive an answer from the Case Manager Nurse of the Center Cinzia Pellegrini 331 1234567).",
"How to reach us","Access by car: driveway entrance in front of the IEO as indicated on the road map (it is possible to park in the courtyard). From the city center to the driveway access in via Ripamonti 428 (site before the roundabout to enter the IEO); from Tangenziale Ovest, exit Val Tidone-Vigentina: continue towards Milano Centro until the roundabout for IEO with direction reversal towards the entrance of the farmhouse.",
"Access by public transport: tram 24 (from Piazza Duomo-Piazza Missori to the terminus): from the terminus, bus 99 or 222 to the first stop right at the pedestrian access to Milcare or a short 10-minute walk.",
"Access by Shuttle: free shuttle service every 30 minutes starting at 09:00 till 18:00 thanks to the IEO Foundation from Piazzale Abbiategrasso (green line underground stop) to the IEO."]');
...
VALUES
(1, 4, 'The autumn socializing workshop is underway', '2020-10-01 10:00:00', 'Milan, Italy', 'event_01.jpg', 'An appointment which over time has found more and more interest and that is why this fourth edition in 2019 had to be split into two separate workshops: Workshop on Tuesday and that the Wednesday in order to accommodate all the applications received.',
...
(3,5,'Plenary meeting OU Territorial Hospital Program', '2020-06-22 10:00:00', 'Turin, Italy', 'event_03.jpg', 'Considering some difficulties that emerged in the realization of the 11th Course for patients with incurable advanced neurological diseases and the 4th Course for terminal patients, Fondazione Milcare decided to modify the organizational structure by providing a single Course for Family Assistants.',
