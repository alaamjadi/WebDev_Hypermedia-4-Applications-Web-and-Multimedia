...
VALUES
(1, 4, 'Autumn socializing workshop', '2020-10-01 10:00:00', 'Milan, Italy', '["event_01.jpg", "autumn_workshop_1.jpg","autumn_workshop_2.jpg","autumn_workshop_3.jpg"]', 'An appointment which over time has found more and more interest and that is why this fourth edition in 2019 had to be split into two separate workshops: Workshop on Tuesday and that the Wednesday in order to accommodate all the applications received.', '["Organizer:","Service:","An appointment which over time has found more and more interest and that is why this fourth edition in 2019 had to be split into two separate workshops: Workshop on Tuesday and that the Wednesday in order to accommodate all the applications received.", "On this occasion, a restitution to citizenship of the summer socializing workshop held from June to September was attended, attended24 Seniors living in blocks of public housing (most reported by the Social Security Services of areas 4-5-6 of the Municipality of Milan) + 4 Guests of the Quintosole Accommodation House (located near Cascina Brandezzata).", "All participants in the 5 Laboratories built in 2019 in Cascina Brandezzata will return their experience on the occasion of the Christmas party in Cascina Brandezzata scheduled for Tuesday 17 December (all Milanese citizens interested are invited)"]'),
